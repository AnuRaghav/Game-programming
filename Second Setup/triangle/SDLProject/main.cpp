...
void update() {
//    g_model_matrix = glm::translate(g_model_matrix, glm::vec3(0.01f,0.0f,0.0f));  // MOVES LINEARLY SIDEWAYS
//    g_model_matrix = glm::rotate(g_model_matrix, 0.05f, glm::vec3(0.0f, 0.0f, 1.0f));
