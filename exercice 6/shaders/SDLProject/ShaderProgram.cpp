...
void ShaderProgram::load(const char *vertex_shader_file, const char *fragment_shader_file, int& thing)
{
    ...
    m_thing = glGetUniformLocation(m_program_id, "thing");
...
void ShaderProgram::set_charging(bool charging){
    glUseProgram(m_program_id);
    glUniform1i(m_thing, charging ? 1 : 0);
}
