...
void update()
{
    ...
    if (g_drops_size.x < 0.0f){
        g_drops_size = glm::vec3(0.0f,0.0f,0.0f);}
//    if (g_drops_scale = glm::vec3(0.0f,0.0f,0.0f)){
//        g_drops_size = g_drops_scale(0.0f, 0.0f,0.0f);
//    }
    // --- TRANSLATION --- //
    g_beaker_matrix = glm::mat4(1.0f);
    ...
    if (x_distance < 0.0f && y_distance < 0.0f )
        {
            ...
            g_drops_scale = glm::vec3(-0.90f,-0.90f,0.0f);
        }
